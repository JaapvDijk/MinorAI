...
class Env(object):
    def __init__(self):
        ...
        self.checkpoints = [
            ...
            CheckPoint(x = 1150, y = 250, width = 200, height = 30),
            ...
            CheckPoint(x = 400, y = 630, width = 30, height = 100),
    ...
    def step(self, action):
        ...
        if not self.draw():
            return
        self.reward = self.agent.check_collsion_car_checkpoint(self.checkpoints) - 0.0001 * self.agent.check_distance_car_checkpoint(self.checkpoints)
