...
class GA:
    ...
    def mutation(self, car):
        ...
        if random.random() < self.mutation_rate:
            ...
            new_car.brain.weights1[rand_index] = new_car.brain.weights1[rand_index] + random.uniform(-0.1, 0.1)
            new_car.brain.weights2[rand_index] = new_car.brain.weights2[rand_index] + random.uniform(-0.1, 0.1)
